...
button_a = tk.Button(root, text="Close the circuit", command=send_command_a, state=tk.DISABLED)
button_a.pack(pady=20)

button_b = tk.Button(root, text="Open the circuit", command=send_command_b, state=tk.DISABLED)
button_b.pack(pady=20)

button_c = tk.Button(root, text="blink three times", command=send_command_c, state=tk.DISABLED)
